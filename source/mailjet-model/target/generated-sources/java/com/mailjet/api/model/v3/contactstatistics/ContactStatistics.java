...
public final class ContactStatistics {
     ...
     * 
     */
    public final static MailJetApiService<com.mailjet.api.client.MailJetApiCall.Retrieve<ContactStatistics>> List = new MailJetApiService<com.mailjet.api.client.MailJetApiCall.Retrieve<ContactStatistics>>(ContactStatistics.class, ResourceOperationTypes.Get);
     ...
     */
    public ContactStatistics setBlockedCount(Long value) {
        BlockedCount = value;
        return this;
    }
     ...
     *     not null, the object on which this method was called 
     */
    public ContactStatistics setBouncedCount(Long value) {
        BouncedCount = value;
        return this;
    }
     ...
     *     not null, the object on which this method was called 
     */
    public ContactStatistics setClickedCount(Long value) {
        ClickedCount = value;
        return this;
    }

    /**
     * Gets "The contact for which statistics are shown." property.
     * 
     * @return
     *     the value set for the property or null if value is not present
     */
    ...
    /**
     * Sets the specified value to "The contact for which statistics are shown." property.
     * 
     * @param value
     *     the new value for the property
     * @return
     *     not null, the object on which this method was called 
     */
    public ContactStatistics setContactID(Long value) {
        ContactID = value;
        return this;
    }
     ...
     *     not null, the object on which this method was called 
     */
    public ContactStatistics setDeliveredCount(Long value) {
     ...
     *     not null, the object on which this method was called 
     */
    public ContactStatistics setLastActivityAt(Date value) {
     ...
     *     not null, the object on which this method was called 
     */
    public ContactStatistics setOpenedCount(Long value) {
        OpenedCount = value;
        return this;
    }
     ...
     *     not null, the object on which this method was called 
     */
    public ContactStatistics setProcessedCount(Long value) {
     ...
     *     not null, the object on which this method was called 
     */
    public ContactStatistics setQueuedCount(Long value) {
        QueuedCount = value;
        return this;
    }
     ...
     *     not null, the object on which this method was called 
     */
    public ContactStatistics setSpamComplaintCount(Long value) {
